...
pub mod user_repos_query {
    ...
    pub struct ReposNodes {
        ...
        pub parent: Option<ReposNodesParent>,
    ...
    #[derive(Deserialize, Debug)]
    pub struct ReposNodesParent {
        pub owner: ReposNodesParentOwner,
    }
    #[derive(Deserialize, Debug)]
    pub struct ReposNodesParentOwner {
        pub login: String,
        #[serde(flatten)]
        pub on: ReposNodesParentOwnerOn,
    }
    #[derive(Deserialize, Debug)]
    #[serde(tag = "__typename")]
    pub enum ReposNodesParentOwnerOn {
        Organization,
        User,
    }
    #[derive(Deserialize, Debug)]
...
pub mod user_contributed_repos_query {
    ...
    pub struct UserContributedReposQueryUserRepositoriesContributedToNodes {
        ...
        pub parent: Option<UserContributedReposQueryUserRepositoriesContributedToNodesParent>,
        pub url: URI,
    }
    #[derive(Deserialize, Debug)]
    ...
    #[derive(Deserialize, Debug)]
    pub struct UserContributedReposQueryUserRepositoriesContributedToNodesParent {
        pub owner: UserContributedReposQueryUserRepositoriesContributedToNodesParentOwner,
    }
    #[derive(Deserialize, Debug)]
    pub struct UserContributedReposQueryUserRepositoriesContributedToNodesParentOwner {
        pub login: String,
        #[serde(flatten)]
        pub on: UserContributedReposQueryUserRepositoriesContributedToNodesParentOwnerOn,
    }
    #[derive(Deserialize, Debug)]
    #[serde(tag = "__typename")]
    pub enum UserContributedReposQueryUserRepositoriesContributedToNodesParentOwnerOn {
        Organization,
        User,
    }
}
